...
namespace EventBusOne
{
    ...
    public class Snowflake
    {
        ...
        public virtual long NextId()
        {
            lock (_lock)
            {
                ...
                if (_lastTimestamp == timestamp)
                {
                    ...
                    {
                        //等待到下一毫秒
                        timestamp = TilNextMillis1(_lastTimestamp);
                    }
                }
                else
                {
        ...
        protected virtual long TilNextMillis1(long lastTimestamp)
        {
            var timestamp = TimeGen1();
        ...
        // 获取当前的时间戳
        protected virtual long TimeGen1()
        {
            return TimeExtensionsw.CurrentTimeMillis();
        }
    }
}
